...
class icit_srdb_ui extends icit_srdb {
    ...
    public function is_wordpress() {
        ...
        $bootstrap_file_found = false;

        while ( ! file_exists( dirname( __FILE__ ) . "{$path_mod}/{$bootstrap_file}" ) || ! file_exists( dirname( __FILE__ ) . "{$path_mod}/web/wp/{$bootstrap_file}" ) ) {
            $path_mod .= '/..';
            if ( $depth ++ >= $max_depth ) {
                break;
            }
        ...
        if ( file_exists( dirname( __FILE__ ) . "{$path_mod}/{$bootstrap_file}" ) ) {
            ...
            $bootstrap_file_found = true;
        } else if (file_exists( dirname( __FILE__ ) . "{$path_mod}/web/wp/{$bootstrap_file}" )) {

            // store WP path
            $this->path = dirname( __FILE__ ) . $path_mod . '/web/wp/';
            $bootstrap_file_found = true;
        }


        if ($bootstrap_file_found) {
...
public function deleted() {
    ...
    <section class="row row-blog">
        ...
        <div class="content">
            <p><a href="http://interconnectit.com/blog/" target="_blank">We couldn't load our blog feed for some reason
                    so here's a link instead!</a></p>
        </div>
    ...
    <section class="row row-products">
        ...
        <div class="content">
            <p><a href="http://interconnectit.com/products/" target="_blank">We couldn't load our product feed for some
